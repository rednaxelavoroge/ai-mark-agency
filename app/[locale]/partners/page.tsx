...
const pageCopy: Record<string, PageCopy> = {
  en: {
    ...
    networkLead: "The network is built around customer sales, not registrations. The standard model supports a maximum five-level structure tied to eligible customer revenue.",
    levels: [
      { n: "L1", title: "Direct sale", body: "The customer you personally introduce." },
      { n: "L2", title: "First network", body: "Eligible customer sales generated by your first-level partners." },
      { n: "L3", title: "Extended network", body: "Eligible sales deeper in the structure under the plan rules." },
      { n: "L4", title: "Market depth", body: "The network continues creating value beyond direct relationships." },
      { n: "L5", title: "Maximum depth", body: "The deepest level supported by the standard network model." },
    ],
  ...
  ru: {
    ...
    networkLead: "Сеть строится вокруг продаж клиентам, а не регистрации людей. Стандартная модель предусматривает максимум пять уровней и привязана к квалифицированной клиентской выручке.",
    levels: [
      { n: "L1", title: "Прямая продажа", body: "Клиент, которого вы привели лично." },
      { n: "L2", title: "Первый уровень сети", body: "Квалифицированные клиентские продажи ваших партнёров первого уровня." },
      { n: "L3", title: "Расширенная сеть", body: "Квалифицированные продажи глубже структуры по правилам программы." },
      { n: "L4", title: "Глубина рынка", body: "Сеть продолжает создавать ценность за пределами прямых связей." },
      { n: "L5", title: "Максимальная глубина", body: "Самый глубокий уровень стандартной модели сети." },
    ],
      ...
      <section id="network" className="scroll-mt-24 border-b border-line">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
          ...
          <div className="mt-10 overflow-hidden rounded-2xl border border-line bg-ink-2">
            ...
            <div className="border-t border-line bg-ink-3/30 px-6 py-4"><div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between"><span className="font-mono text-[10px] tracking-wider text-muted uppercase">{t.commissionLabel}</span><span className="text-xs text-paper/80">{t.commissionNote}</span></div></div>
          </div>
        </div>
      </section>
