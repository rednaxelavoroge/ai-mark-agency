...
export function InvestorsSection({ locale }: { locale: Locale }) {
  ...
  const fundamentals = isRu
    ? [
        ...
        { title: "Сквозная бизнес-модель", desc: "Диверсифицированная выручка: SaaS-подписки от $39–$359/мес, ретейнеры на AI-маркетинг от $1,200/мес и заказные цифровые внедрения." },
    ...
    : [
        ...
        { title: "Diversified Revenue Mix", desc: "SaaS subscriptions from $39–$359/mo, marketing department retainers from $1,200/mo, and high-ticket digital production contracts." },
