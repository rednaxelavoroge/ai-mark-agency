...
export const copyJa: Copy = {
  "meta": {
    "title": "AI MARK — アイデアから稼働するビジネスへ",
    "description": "AIネイティブのベンチャー創出・マーケティング企業。市場調査からビジネスモデル構築、プロダクト開発、AI主導のマーケティング・営業までを一気通貫で支援します。",
    "ogTitle": "AI MARK — アイデアから持続可能な事業へ",
    "keywords": [
      "AI-native company",
      "business creation",
      "AI marketing",
  ...
  "contact": {
    ...
    "formNote": "お名前と連絡先を残してください。パートナーのリンクから来た場合、この依頼はそのパートナーに紐づきます。送信は支払いではありません。",
    "formCta": "連絡先を残す",
    "name": "Name",
    "email": "Email",
  ...
  "footer": {
    "blurb": "AIネイティブのベンチャー創出＆マーケティング企業。独自のAIインフラでアイデアを確かな事業へ。",
    "privacy": "Privacy",
