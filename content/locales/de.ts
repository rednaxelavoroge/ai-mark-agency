...
export const copyDe: Copy = {
  "meta": {
    "title": "AI MARK — Von der Idee zum laufenden Unternehmen",
    "description": "AI-native Venture- und Marketinggesellschaft. Wir analysieren Märkte, strukturieren Geschäftsmodelle, entwickeln digitale Produkte und steuern Marketing, Vertrieb und Skalierung über eigene KI-Infrastruktur.",
    "ogTitle": "AI MARK — Von der Idee zum laufenden Unternehmen",
    "keywords": [
      "AI-native company",
      "business creation",
      "AI marketing",
    ...
    "tiers": [
      {
        "name": "Starter",
        "price": "$1,200",
        "body": "Für den Einstieg in die Automatisierung: Einrichtung von 1 KI-System auf dem Hauptkanal."
      },
      {
        "name": "Growth",
        "price": "$2,200",
        "body": "Für wachstumsorientierte Unternehmen: AIME + AIBA und aktive Kampagnensteuerung."
      },
      {
        "name": "Scale",
        "price": "$3,500",
  ...
  "footer": {
    "blurb": "AI-native Venture & Marketing Company. Von der Idee zum rentablen Unternehmen auf eigener KI-Infrastruktur.",
    "privacy": "Privacy",
