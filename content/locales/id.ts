...
export const copyId: Copy = {
  "meta": {
    "title": "AI MARK — Dari Ide Menjadi Bisnis Nyata",
    "description": "Perusahaan venture builder dan pemasaran AI-native. Kami meriset pasar, merumuskan model, membangun produk digital, lalu menjalankan pemasaran, penjualan, dan pertumbuhan dengan infrastruktur AI kami sendiri.",
    "ogTitle": "AI MARK — Dari Ide Menjadi Bisnis Nyata",
    "keywords": [
      "AI-native company",
      "business creation",
      "AI marketing",
  ...
  "footer": {
    "blurb": "Perusahaan venture builder & pemasaran AI-native. Dari ide menjadi bisnis nyata di atas infrastruktur mandiri.",
    "privacy": "Privacy",
