...
export const copyAr: Copy = {
  "meta": {
    "title": "AI MARK — من الفكرة إلى شركة ناجحة",
    "description": "شركة تسويق واستثمار ريادي معتمدة على الذكاء الاصطناعي الأصيل. ندرس السوق، ونبني النموذج، ونطور المنتجات الرقمية، ثم ندير التسويق والمبيعات عبر بنيتنا التحتية الخاصة.",
    "ogTitle": "AI MARK — من الفكرة إلى شركة ناشئة ناجحة",
    "keywords": [
      "ذكاء اصطناعي",
      "تأسيس شركات",
  ...
  "pillars": {
    ...
    "items": [
      ...
      },
      {
        ...
        "body": "فرز وتأهيل العملاء، رد فوري عبر كافة القنوات، وإصدار عروض أسعار آلية والإغلاق السريع."
      },
      {
        "n": "05",
  ...
  "creation": {
    ...
    "steps": [
      {
        "title": "الانطلاق من فكرة",
        "body": "تحليل السوق، وتصميم وتطوير النموذج الأولي (MVP)، وإطلاق العمليات التشغيلية والتسويقية."
      },
      {
  ...
  "products": {
    ...
    "title": "برمجيات جاهزة للنشر الفوري وتوليد الإيرادات.",
    "lead": "منتجات تقنية متطورة تعمل باستقلالية مع ضمان الرقابة البشرية.",
    "whoLabel": "الفئة المستهدفة",
    "extraLabel": "الميزة الأساسية",
    "detailCta": "عرض التفاصيل",
    "installCta": "طلب النظام",
    "hubCta": "جميع المنتجات",
    "hubTitle": "كتالوج منتجات الذكاء الاصطناعي",
    "hubLead": "أنظمة ذاتية القيادة مجهزة لتسريع عمليات البيع والتسويق لشركتك.",
    "items": {
      "aime": {
        "value": "AIME — موظف التسويق بالذكاء الاصطناعي",
        "who": "العلامات التجارية، المتاجر الإلكترونية والوكالات",
        "extra": "تخطيط المحتوى وتوليد المنشورات والنشر التلقائي في Instagram و Facebook و Threads بموافقة عبر تليجرام.",
        "price": "يبدأ من 199$ / شهرياً"
      },
      "assistant": {
        "value": "مساعد الأعمال الذكي (AIBA)",
        "who": "الشركات العقارية، قطاع الخدمات، التجارة والشركات B2B",
        "extra": "خدمة عملاء ومبيعات فورية 24/7 عبر واتساب وتليجرام والموقع الإلكتروني وتأهيل العملاء للـ CRM.",
        "price": "يبدأ من 149$ / شهرياً"
      },
      "showroom": {
        "value": "Showroom AI — حاسبة المواصفات وعروض الأسعار",
    ...
    "tiers": [
      {
        "name": "Starter",
        "price": "$1,200",
        "body": "للشركات الراغبة في بدء الأتمتة: تشغيل منتج ذكاء اصطناعي واحد على قناة أساسية."
      },
      {
        "name": "Growth",
        "price": "$2,200",
        "body": "للشركات النامية: ربط AIME و AIBA وإدارة الحملات التسويقية النشطة."
      },
      {
        "name": "Scale",
        "price": "$3,500",
        "body": "حل شامل ومتكامل: أتمتة كاملة للقنوات، نظام Showroom AI ودعم فني مخصص 24/7."
      }
    ],
  ...
  "contact": {
    ...
    "title": "دعنا نناقش المرحلة القادمة من نمو أعمالك.",
    "lead": "أدخل بياناتك وسنقوم بجدولة جلسة استراتيجية مدتها 20 دقيقة مع مؤسسي الشركة.",
    "formNote": "اترك الاسم وطريقة للتواصل. إذا وصلت عبر رابط شريك، تُنسب هذه الطلبية إلى ذلك الشريك. الإرسال ليس دفعًا.",
    "formCta": "اترك بياناتك",
    "name": "الاسم الكامل",
    "email": "البريد الإلكتروني للعمل",
    "messenger": "واتساب أو تليجرام",
    "messengerHint": "Handle or number",
    "company": "الشركة أو المشروع",
    "scenario": "الهدف الرئيسي",
    "scenarioOptions": [
      {
        "value": "idea",
  ...
  "footer": {
    "blurb": "شركة استثمار وتسويق بالذكاء الاصطناعي الأصيل. من الفكرة إلى شركة ناجحة على بنية تحتية خاصة ومحمية.",
    "privacy": "سياسة الخصوصية",
    "rights": "AI MARK. جميع الحقوق محفوظة.",
    "poweredBy": ""
  },
  "privacy": {
    "title": "Privacy",
