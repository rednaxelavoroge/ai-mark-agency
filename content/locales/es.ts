...
export const copyEs: Copy = {
  "meta": {
    "title": "AI MARK — De la Idea a un Negocio Rentable",
    "description": "Empresa de capital de riesgo y marketing impulsada por IA. Investigamos el mercado, estructuramos el modelo, desarrollamos el producto digital y operamos marketing, ventas y crecimiento con nuestra propia infraestructura de IA.",
    "ogTitle": "AI MARK — De la Idea al Negocio Rentable",
    "keywords": [
  ...
  "products": {
    ...
    "title": "Software listo para instalar y generar ingresos.",
    "lead": "Nuestras soluciones propietarias de IA operan autónomamente con supervisión humana.",
    "whoLabel": "Para quién",
    ...
    "items": {
      "aime": {
        "value": "AIME — Empleado de marketing con IA",
        "who": "Marcas, tiendas de e-commerce y agencias",
        "extra": "Planificación, diseño y publicación autónoma en Instagram, Facebook y Threads con aprobación vía Telegram.",
        "price": "Desde $199/mes"
      },
      "assistant": {
        "value": "AI Business Assistant",
        "who": "Empresas de servicios, inmobiliarias, B2B y retail",
        "extra": "Asistente omnicanal 24/7 en WhatsApp, Telegram y web con calificación y captura de leads en CRM.",
        "price": "Desde $149/mes"
      },
      "showroom": {
        "value": "Showroom.pro",
  ...
  "contact": {
    ...
    "sending": "Enviando...",
    "success": "¡Solicitud recibida! Le responderemos en menos de 2 horas hábiles.",
    "error": "Ocurrió un error. Por favor escriba a hello@ai-mark.agency",
  ...
  "footer": {
    "blurb": "Empresa de capital riesgo y marketing nativa de IA. De la idea al negocio rentable sobre infraestructura propietaria.",
    "privacy": "Privacidad",
    "rights": "AI MARK. Todos los derechos reservados.",
    "poweredBy": ""
  },
  "privacy": {
    "title": "Privacy",
