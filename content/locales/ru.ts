...
export const copyRu: Copy = {
    ...
    products: {
      ...
      hubLead:
        "AIME, AI Business Assistant и Showroom.pro — AI-продавец. Ведём их для клиентов и можем поставить на ваши аккаунты. Ниже — только то, что продукты реально делают.",
      items: {
        aime: {
          value:
