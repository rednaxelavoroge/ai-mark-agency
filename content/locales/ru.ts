...
export const copyRu: Copy = {
    ...
    pillars: {
      ...
      items: [
        ...
        },
        {
          n: "04",
          title: "AI-продажи",
          body: "От первого обращения до квалификации, подбора решения, расчёта и коммерческого предложения — AI Business Assistant и Showroom.pro.",
        },
        {
          n: "05",
          title: "Рост",
    ...
    products: {
      ...
      hubLead:
        "AIME ведёт маркетинговый цикл до вашего апрува. AI Business Assistant отвечает и квалифицирует. Showroom.pro — AI-продавец подбирает, считает и готовит коммерческое предложение.",
      items: {
        aime: {
          value:
        ...
        assistant: {
          value:
            "Ответы, база знаний, квалификация, поддержка и передача человеку. Цену и коммерческое предложение готовит Showroom.pro.",
      ...
      tiers: [
        {
          name: "AI-продукты",
          price: "$149–349+",
          body: "AIME, Business Assistant, Showroom.pro — AI-продавец как продуктовые SKU — у себя или с нашей поставкой.",
        },
        {
      ...
      items: {
        ...
        growth: {
          ...
          points: [
            ...
            "Inbox и Showroom.pro, если офферу это нужно",
    ...
    productPages: {
      ...
      assistant: {
        ...
        lead: "Отвечает и квалифицирует, затем передаёт диалог человеку. Продаёт и готовит сделку Showroom.pro.",
      ...
      showroom: {
        eyebrow: "AI-продавец",
        title: "Showroom.pro — AI-продавец",
        ...
        sections: [
          ...
          {
            title: "Где стоит",
            body: "После маркетинга или квалификации в inbox. Showroom.pro превращает разговор и параметры в выверенный коммерческий документ.",
          },
        ],
