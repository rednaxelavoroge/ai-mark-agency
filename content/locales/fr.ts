...
export const copyFr: Copy = {
  "meta": {
    "title": "AI MARK — De l'Idée à l'Entreprise Opérationnelle",
    "description": "Société de capital-risque et de marketing native IA. Nous étudions le marché, concevons le modèle, développons le produit digital et gérons le marketing et les ventes grâce à notre propre infrastructure d'IA.",
    "ogTitle": "AI MARK — De l'Idée à l'Entreprise Opérationnelle",
    "keywords": [
      "AI-native company",
      "business creation",
      "AI marketing",
    ...
    "steps": [
      {
        ...
        "body": "Demand, competitors, constraints, and where a real offer can sit."
      },
      {
        "title": "Opportunities",
        "body": "A short list of spaces worth building in — with reasons, not slogans."
      },
      {
  ...
  "contact": {
    ...
    "formNote": "Laissez un nom et un moyen de vous joindre. Si vous êtes arrivé par un lien partenaire, cette demande est attribuée à ce partenaire. L'envoi n'est pas un paiement.",
    "formCta": "Laisser vos coordonnées",
    "name": "Name",
    "email": "Email",
  ...
  "footer": {
    "blurb": "Société de venture building et marketing native IA. De l'idée à l'entreprise rentable sur notre propre infrastructure.",
    "privacy": "Privacy",
