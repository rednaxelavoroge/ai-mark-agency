...
export const copyZh: Copy = {
  "meta": {
    "title": "AI MARK — 从商业创意到落地盈利",
    "description": "AI原生创业孵化与数字营销公司。我们深入调研市场，打磨商业模型，打造数字化产品，并通过自主研发的 AI 基础设施驱动营销、销售与全流程增长。",
    "ogTitle": "AI MARK — 从创意到成熟商业模式",
    "keywords": [
      "AI原生企业",
      "商业孵化",
      "AI营销",
  ...
  "creation": {
    ...
    "steps": [
      {
        "title": "基于创意立项",
        "body": "行业深度调研、商业模式打磨、敏捷 MVP 研发、AI 智能体部署及商业化上线。"
      },
      {
        "title": "基于资本驱动",
  ...
  "products": {
    ...
    "title": "开箱即用、快速赋能商业营收的软件系统。",
    "lead": "具备自主决策能力的专业智能体系统，并在关键节点接受人工审核保障。",
    ...
    "items": {
      "aime": {
        ...
        "who": "消费品牌、出海跨境电商与营销机构",
        "extra": "自主完成 Instagram、Facebook、Threads 内容策划、排版与发布，通过 Telegram 一键审核。",
        "price": "199 美元/月起"
      },
      "assistant": {
        "value": "AI Business Assistant 业务助手",
        "who": "房产顾问、高端服务业、B2B 外贸与企业客发",
        "extra": "7×24 全渠道在线（WhatsApp / Telegram / 网页），智能初筛潜客并自动归档至 CRM 系统。",
        "price": "149 美元/月起"
      },
      "showroom": {
    ...
    "tiers": [
      {
        "name": "Starter 入门版",
        "price": "$1,200",
        "body": "适合初步尝试业务自动化：部署 1 款核心 AI 智能体及单一主渠道对接。"
      },
      {
        "name": "Growth 成长版",
        "price": "$2,200",
        "body": "适合加速销售扩张：组合部署 AIME 与 AIBA，并由专业团队持续调优营销。"
      },
      {
        "name": "Scale 规模版",
        "price": "$3,500",
  ...
  "footer": {
    "blurb": "AI 原生创业孵化与营销科技公司。依托自研智能基座，实现从创意到成熟盈利业务的高速落地。",
    "privacy": "隐私合规政策",
    "rights": "AI MARK. 保留所有权利。",
    "poweredBy": ""
  },
  "privacy": {
    "title": "Privacy",
