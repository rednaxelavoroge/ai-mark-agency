...
export const copyPt: Copy = {
  "meta": {
    "title": "AI MARK — Da Ideia ao Negócio em Operação",
    "description": "Empresa de venture builder e marketing nativa em IA. Pesquisamos o mercado, estruturamos o modelo, desenvolvemos o produto digital e operamos marketing, vendas e escala com infraestrutura proprietária de IA.",
    "ogTitle": "AI MARK — Da Ideia ao Negócio em Operação",
    "keywords": [
  ...
  "nav": {
    "items": [
      ...
      },
      {
        ...
        "label": "Criação de negócios"
      },
      {
        "href": "/products",
        "label": "Produtos de IA"
      },
      {
        "href": "#how",
        "label": "Como funciona"
  ...
  "creation": {
    ...
    "steps": [
      {
        "title": "Com uma ideia",
        "body": "Auditoria de mercado, arquitetura do produto, MVP ágil, infraestrutura de IA e lançamento comercial."
      },
      {
  ...
  "products": {
    ...
    "title": "Software pronto para plugar e gerar receita.",
    "lead": "Soluções proprietárias de IA que operam de forma autônoma com controle humano.",
    "whoLabel": "Para quién",
    "extraLabel": "Ventaja clave",
    "detailCta": "Ver detalles",
    "installCta": "Conectar",
    "hubCta": "Ver todos los productos",
    "hubTitle": "Catálogo de productos de IA",
    "hubLead": "Sistemas autónomos listos para integrarse en su flujo de trabajo comercial.",
    "items": {
      "aime": {
        "value": "AIME — Funcionário de marketing com IA",
        "who": "Marcas, e-commerces e agências",
        "extra": "Planejamento, redação, design e postagem automática no Instagram, Facebook e Threads com aprovação no Telegram.",
        "price": "A partir de $199/mês"
      },
      "assistant": {
        "value": "AI Business Assistant",
        "who": "Prestadores de serviços, imobiliárias, B2B e varejo",
        "extra": "Atendente omnicanal 24/7 no WhatsApp, Telegram e site com qualificação e envio de leads para CRM.",
        "price": "A partir de $149/mês"
      },
      "showroom": {
        "value": "Showroom.pro",
        "who": "Indústrias, fabricantes, móveis planejados e projetos sob medida",
        "extra": "Gerador instantâneo de especificações técnicas e propostas comerciais em PDF com regras de negócio.",
    ...
    "tiers": [
      {
        "name": "Starter",
        "price": "$1,200",
        "body": "Para empresas iniciando automação: configuração de 1 produto de IA e canal principal."
      },
      {
        "name": "Growth",
        "price": "$2,200",
        "body": "Para aceleração de vendas: AIME + AIBA integrados e gestão ativa de campanhas."
      },
      {
        "name": "Scale",
        "price": "$3,500",
        "body": "Ecossistema completo: atendimento multicanal, Showroom.pro — AI Sales Agent e suporte prioritário 24/7."
      }
    ],
  ...
  "why": {
    ...
    "close": "That does not mean every company that still works by hand will disappear. It does mean the builders who already have the loop can move faster."
  },
  "investors": {
    "eyebrow": "Investors",
    ...
    "scale": "Open to early financing at commercial scale-up. Size and structure are individual. Later, larger rounds can follow if clients, revenue, and presence support them — not as a promise.",
  ...
  "contact": {
    ...
    "title": "Vamos conversar sobre o seu próximo salto de crescimento.",
    "lead": "Deixe seus dados e agendaremos uma sessão estratégica de 20 minutos com nossos fundadores.",
    "formNote": "Deixe o nome e uma forma de contacto. Se chegou pelo link de um parceiro, o pedido fica atribuído a esse parceiro. Enviar isto não é um pagamento.",
    "formCta": "Deixar contato",
    "name": "Nome completo",
    "email": "E-mail corporativo",
    "messenger": "WhatsApp ou Telegram",
    "messengerHint": "Handle or number",
    "company": "Empresa ou projeto",
    "scenario": "Objetivo principal",
    "scenarioOptions": [
      {
        "value": "idea",
        "label": "I have an idea",
        "hint": "Concept, not yet a company — or barely one."
      },
      {
        "value": "business",
        "label": "I have a business",
        "hint": "Something already operates. You want the loop."
      },
      {
        "value": "capital",
        "label": "I have capital",
        "hint": "You want to build from the market, not from a leftover idea."
      },
      {
        "value": "marketing",
        "label": "I need AI marketing",
        "hint": "Department, services, or product install."
      },
      {
        "value": "partner",
        "label": "I want to partner",
        "hint": "Regional, industry, referral, or agency."
      },
      {
        "value": "investment",
        "label": "I'm considering investment",
        "hint": "Conversation about participation — not a pitch deck promise."
      }
    ],
  ...
  "footer": {
    "blurb": "Venture builder e marketing nativa em IA. Da ideia ao negócio em operação sobre infraestrutura proprietária.",
    "privacy": "Privacidade",
    "rights": "AI MARK. Todos os direitos reservados.",
    "poweredBy": ""
  },
  "privacy": {
    "title": "Privacy",
