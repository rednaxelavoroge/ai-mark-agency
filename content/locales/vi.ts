...
export const copyVi: Copy = {
  "meta": {
    "title": "AI MARK — Từ Ý Tưởng Đến Doanh Nghiệp Hoạt Động",
    "description": "Công ty phát triển liên doanh và tiếp thị AI-native. Chúng tôi nghiên cứu thị trường, xây dựng mô hình, phát triển sản phẩm kỹ thuật số, sau đó vận hành tiếp thị và bán hàng bằng hạ tầng AI độc quyền.",
    "ogTitle": "AI MARK — Từ Ý Tưởng Đến Doanh Nghiệp Hoạt Động",
    "keywords": [
      "AI-native company",
      "business creation",
      "AI marketing",
  ...
  "footer": {
    "blurb": "Công ty khởi tạo doanh nghiệp & tiếp thị AI-native. Từ ý tưởng đến doanh nghiệp thành công trên hạ tầng AI.",
    "privacy": "Privacy",
