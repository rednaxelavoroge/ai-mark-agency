...
export const copyTr: Copy = {
  "meta": {
    "title": "AI MARK — Fikirden Çalışan Bir İşletmeye",
    "description": "Yapay zeka odaklı girişim kurucu ve pazarlama şirketi. Pazar araştırması yapıyor, modeli kuruyor, dijital ürünü geliştiriyor ve pazarlama ile satış operasyonlarını kendi yapay zeka altyapımızla büyütüyoruz.",
    "ogTitle": "AI MARK — Fikirden Çalışan Bir İşletmeye",
    "keywords": [
      "AI-native company",
      "business creation",
      "AI marketing",
  ...
  "footer": {
    "blurb": "Yapay zeka odaklı girişim kurucu ve pazarlama şirketi. Kendi altyapımızla fikirden karlı bir işletmeye.",
    "privacy": "Privacy",
